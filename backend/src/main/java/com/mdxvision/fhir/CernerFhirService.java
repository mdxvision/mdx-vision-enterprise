 ...
 */
@Service
public class CernerFhirService {

    private static final Logger log = LoggerFactory.getLogger(CernerFhirService.class);

    private final FhirContext fhirContext;
    private IGenericClient fhirClient;

    @Value("${mdx.cerner.base-url:https://fhir-open.cerner.com/r4/ec2458f2-1e24-41c8-b71b-0e701af7583d}")
    private String cernerBaseUrl;

    @Value("${mdx.cerner.access-token:}")
    private String accessToken;

    public CernerFhirService(FhirContext fhirContext) {
        this.fhirContext = fhirContext;
    }

    private IGenericClient getClient() {
        if (fhirClient == null) {
            fhirClient = fhirContext.newRestfulGenericClient(cernerBaseUrl);
    ...
    public Optional<Patient> getPatientById(String patientId) {
        try {
            ...
            log.error("Cerner: Error fetching patient {}: {}", patientId, e.getMessage());
        }
    ...
    public List<Patient> searchPatientsByName(String name) {
        ...
        try {
            ...
            log.error("Cerner: Error searching patients: {}", e.getMessage());
        }
        return patients;
    }
    ...
    public Optional<Patient> getPatientByMrn(String mrn) {
        try {
            ...
            log.error("Cerner: Error fetching patient by MRN {}: {}", mrn, e.getMessage());
        }
        return Optional.empty();
    }
    ...
    public List<Observation> getPatientVitals(String patientId) {
        ...
        try {
            ...
            log.error("Cerner: Error fetching vitals for patient {}: {}", patientId, e.getMessage());
        }
        return vitals;
    }
    ...
    public List<Condition> getPatientConditions(String patientId) {
        ...
        try {
            ...
            log.error("Cerner: Error fetching conditions for patient {}: {}", patientId, e.getMessage());
        }
        return conditions;
    }
    ...
    public List<MedicationRequest> getPatientMedications(String patientId) {
        ...
        try {
            ...
            log.error("Cerner: Error fetching medications for patient {}: {}", patientId, e.getMessage());
        }
        return medications;
    }
    ...
    public List<AllergyIntolerance> getPatientAllergies(String patientId) {
        ...
        try {
            ...
            log.error("Cerner: Error fetching allergies for patient {}: {}", patientId, e.getMessage());
        }
        return allergies;
    }
    ...
    public List<Encounter> getPatientEncounters(String patientId) {
        ...
        try {
            ...
            log.error("Cerner: Error fetching encounters for patient {}: {}", patientId, e.getMessage());
        }
        return encounters;
    }
}
