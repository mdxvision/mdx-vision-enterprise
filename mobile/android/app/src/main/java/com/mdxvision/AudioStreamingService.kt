...
class AudioStreamingService(
    ...
    companion object {
        ...
        private var wsUrlDevice: String = "ws://192.168.1.243:8002/ws/transcribe?noise_reduction=false"
            ...
            recordingJob = scope.launch {
                ...
                while (isActive && isStreaming) {
                    ...
                    if (readCount > 0) {
                        ...
                        // Boost by ~40dB (100x) to bring levels up to usable range for speech recognition
