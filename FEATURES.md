...
| Feature | Status | Location |
|---------|--------|----------|
| [ ] SOAP note generation | Pending | `ai-service/` ready |
| [ ] Real-time transcription | Pending | AssemblyAI integration |
| [ ] AI-structured notes | Pending | Azure OpenAI integration |
